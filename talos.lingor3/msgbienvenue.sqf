...
_welcomeMessage = format["Bienvenue %1",format["%1", name player]];
_camDistance = 40;
...
_role1 = "Bienvenue sur Talos-Serveur";
_role1names = ["Serveur Français"];
_role2 = "Site/Forum";
_role2names = ["Talos-Serveur.com"];
_role3 = "TeamSpeak3";
_role3names = ["51.254.15.110:9173"];
_role4 = "Attention";
_role4names = ["Tous manquement envers les lois sera punis"];
