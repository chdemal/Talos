...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_Vehicles_HEMTT = ["shounka_a3_mantgs_f"];
	...
	IL_Supported_SUV = ["shounka_a3_pompier_sprinter","Mrshounka_evox_civ","Mrshounka_r5_civ","shounka_nemo","Mrshounka_a3_smart_civ","Mrshounka_twingo_p","Mrshounka_a3_ds3_civ","Mrshounka_lincoln_civ","Mrshounka_c4_p_civ","Mrshounka_mercedes_190_p_civ","Mrshounka_207_civ","shounka_a3_ds4_civ","shounka_buggy","Mrshounka_golfvi_civ","shounka_transam","shounka_a3_cliors_civ","Mrshounka_megane_rs_2015_civ","Mrshounka_cherokee_noir","Mrshounka_a3_308_civ","Mrshounka_raptor_civ","Mrshounka_a3_308_rcz","shounka_a3_peugeot508_civ","Mrshounka_raptor2_civ","shounka_avalanche","Mrshounka_mustang_civ","Mrshounka_Volkswagen_Touareg_civ","Mrshounka_bmwm1_civ","Mrshounka_Alfa_Romeo_civ","shounka_a3_audiq7_bleu","shounka_a3_spr_civ","Mrshounka_Vandura_civ","Mrshounka_lykan_c","Mrshounka_veneno_c","Mrshounka_pagani_c","Mrshounka_agera_p","Mrshounka_hummer_civ","mrshounka_huracan_c","mrshounka_92_civ","shounka_gt","Mrshounka_Bowler_c","shounka_f430_spider","Mrshounka_cayenne_p_civ","shounka_porsche911","shounka_clk","Mrshounka_a3_gtr_civ","Mrshounka_c63_2015_civ","shounka_rs6","shounka_a3_rs5_civ","Mrshounka_a3_308_gend","Mrshounka_308pol","shounka_a3_gendsprinter","shounka_a3_508gend","Mrshounka_a3_rs_gend","Mrshounka_rs_2015_g","Mrshounka_Volkswagen_Touareg_police_police","shounka_a3_audiq7_v2_gendarmerie","Mrshounka_bmw_gend","Mrshounka_rs4_gend_p_blanc","Mrshounka_agera_gend_p","shounka_a3_suburbangign","B_MRAP_01_F"];
	IL_Supported_Hatchback = [""];
	IL_Supported_Hummvee = [""];
	IL_Supported_Quadbike = ["Mrshounka_ducati_p","Mrshounka_yamaha_p","Mrshounka_ducati_police_p"];
		...
		{
			{
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-9 - _cargo_offset,_zload], [_x_cargo_offset,_counter + 0.4 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors == "B")) then
						{
...
if (_obj_main_type in IL_Supported_Vehicles_CHINOOK) then
{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Activer le chargement depuis l'extérieur</t>",
	{
		(_this select 0) setVariable["can_outside", true, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && !(_target getVariable 'can_outside') && IL_Can_Outside)"
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Désactiver le chargement depuis l'extérieur</t>",
	{
		(_this select 0) setVariable["can_outside", false, true];;
	},[],IL_Action_S_Priority,false,true,"",
	"(((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'can_outside') && IL_Can_Outside)"
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger le véhicule dans la dépanneuse</t>",
	{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Décharger le véhicule de la dépanneuse</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
